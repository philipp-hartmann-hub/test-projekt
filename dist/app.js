...
const TRANSLATIONS = {
  de: {
    ...
    'application.type.laufzettel_mietgeraete': 'Mietgeräte (Radio & Fernseher)',
    'application.type.kuendigung_tv_mietvertrag': 'Kündigung des TV-Mietvertrags',
    'application.type.telio_ueberweisung': 'Überweisung an das Telio-Konto',
...
class AntragSystem {
  ...
  getAntragTypLabel(type) {
    ...
    const labels = {
      ...
      'laufzettel-mietgeraete': 'Mietgeräte (Radio & Fernseher)',
      'kuendigung-tv-mietvertrag': 'Kündigung des TV-Mietvertrags',
      'telio-ueberweisung': 'Überweisung an das Telio-Konto',
