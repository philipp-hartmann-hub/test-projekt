...
function loadJSONDatabase() {
  ...
  return {
    users: [
      ...
      { id: 'avd-1', username: 'avd1', password: 'avd1', name: 'Anna Schmidt (AVD)', rolle: 'mitarbeiter', jva: null, jvas: [{id: 'haus1', name: 'Haus 1'}], station: 'Station 1', geburtsdatum: null, insassenNummer: null },
      { id: 'avd-2', username: 'avd2', password: 'avd2', name: 'Peter Weber (AVD)', rolle: 'mitarbeiter', jva: null, jvas: [{id: 'haus2', name: 'Haus 2'}], station: 'Station 2', geburtsdatum: null, insassenNummer: null },
      ...
      { id: 'insasse-1', username: 'insasse1', password: 'insasse1', name: 'Hans Mueller', rolle: 'insasse', jva: 'haus1', jvas: [], station: 'Station 1', geburtsdatum: '1985-03-15', insassenNummer: 'INS-001' },
      { id: 'insasse-2', username: 'insasse2', password: 'insasse2', name: 'Klaus Fischer', rolle: 'insasse', jva: 'haus2', jvas: [], station: 'Station 2', geburtsdatum: '1990-07-22', insassenNummer: 'INS-002' }
    ],
    antraege: [],
    aufgaben: [],
    notifications: [],
