...
function loadJSONDatabase() {
  ...
  return {
    users: [
      ...
      { id: 'revision-1', username: 'revision1', password: 'revision1', name: 'Rita Revision', rolle: 'revision', jva: null, jvas: [], station: null, geburtsdatum: null, insassenNummer: null },
      { id: 'medizin-1', username: 'medizin1', password: 'medizin1', name: 'Maria Medizinischer Dienst', rolle: 'medizinischer-dienst', jva: null, jvas: [], station: null, geburtsdatum: null, insassenNummer: null },
      { id: 'psychologe-1', username: 'psychologe1', password: 'psychologe1', name: 'Paul Psychologe', rolle: 'psychologe', jva: null, jvas: [], station: null, geburtsdatum: null, insassenNummer: null },
